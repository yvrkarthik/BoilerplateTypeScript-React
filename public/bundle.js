...
var MainApp_1 = __webpack_require__(/*! ./components/MainApp */ "./src/components/MainApp.tsx");
ReactDOM.render(React.createElement(MainApp_1.MainApp, null), document.getElementById("app"));
...
var MainApp = /** @class */ (function (_super) {
    ...
    MainApp.prototype.render = function () {
        return (React.createElement("div", null,
            React.createElement(Header_1.Header, { language: this._language, compiler: this._compiler })));
    };
    return MainApp;
}(React.Component));
